...
Need to initialize postgres user and db

If you want to use slim instead of haml, remove the entries for haml in Gemfile and use 
  gem "slim-rails"
then, install `haml2slim`[https://github.com/slim-template/haml2slim] to convert
